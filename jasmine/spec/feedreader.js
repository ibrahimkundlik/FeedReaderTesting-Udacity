...
$(function() {
    ...
    describe('The menu', function() {
         ...
         */
        it('toggles menu when icon is clicked', function() {
            const menuIcon = document.querySelector('a.menu-icon-link');
            menuIcon.click();
            expect(menuCheck()).toBe(false);
            menuIcon.click();
            expect(menuCheck()).toBe(true);
        });
    });
    ...
    describe('Initial Entries', function() {
        ...
        it('has entry in feed container', function() {
            ...
            const entry = feedContainer.querySelectorAll('.entry');
